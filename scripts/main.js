...
var NAME = "James Osborne";
console.log( "/*****************/\n" + NAME +"'s submission \nfor Whodat Assignment" + "\n/*****************/\n");


///////////AS YOU CAN SEE THIS IS THE ASSIGNMENT THAT I HAVE REPURPOSED FOR MY OWN USE////////////BUT I DID DO IT!!!!
...
//document.getElementById("//").addEventListener("mouseover", mouseOver);
//document.getElementById("//").addEventListener("mouseout", mouseOut);


var wingL = document.getElementsByClassName('wing_L');
var wingR = document.getElementsByClassName('wing_R');

var legL = document.getElementsByClassName('leg_L');
var legR = document.getElementsByClassName('leg_R');

var earL = document.getElementsByClassName('ear_L');
var earR = document.getElementsByClassName('ear_R');

var body = document.getElementsByClassName('body prpl-d4');

var pupil = document.getElementsByClassName('pupil');

var footL = document.getElementsByClassName('foot_L');
var footR = document.getElementsByClassName('foot_R');



wingL[0].setAttribute( "style", "background-color: black");
wingR[0].setAttribute( "style", "background-color: black");

wingL[1].setAttribute( "style", "background-color: black");
wingR[1].setAttribute( "style", "background-color: black");


//////////////////////////////////////////////////////////

legL[0].setAttribute( "style", "background-color: black");
legR[0].setAttribute( "style", "background-color: black");

legL[1].setAttribute( "style", "background-color: black");
legR[1].setAttribute( "style", "background-color: black");


//////////////////////////////////////////////////////////

earL[0].setAttribute( "style", "border-left: 60px solid #000000");
earR[0].setAttribute( "style", "border-right: 60px solid #000000");

earL[1].setAttribute( "style", "border-left: 60px solid #000000");
earR[1].setAttribute( "style", "border-right: 60px solid #000000");

//////////////////////////////////////////////////////////

body[0].setAttribute( "style", "background-color: black");
body[1].setAttribute( "style", "background-color: black");

//////////////////////////////////////////////////////////

pupil[0].setAttribute( "style", "background-color: black");
pupil[1].setAttribute( "style", "background-color: black");

pupil[2].setAttribute( "style", "background-color: black");
pupil[3].setAttribute( "style", "background-color: black");
...
////function mouseOver() {
//
//wingL[0].setAttribute( "style", "background-color: grey");
////wingL[1].setAttribute( "style", "background-color: grey");
//
//
//
//wingR[0].setAttribute( "style", "background-color: grey");
////wingR[1].setAttribute( "style", "background-color: grey");
////}
////
////function mouseOut() {
//
//wingL[0].setAttribute( "style", "background-color: white");
//wingL[1].setAttribute( "style", "background-color: white");
//
//wingR[0].setAttribute( "style", "background-color: white");
//wingR[1].setAttribute( "style", "background-color: white");
//}
...
cage[0].setAttribute('style', 'background-color: white', 'opacity: 0')
cage[1].setAttribute('style', 'background-color: white', 'opacity: 0')
